<template>
  <view class="container">
    ...
    <demo-block title="选择年月">
      <i-datetime-picker v-model="value.yearMonth" type="year-month" />
    </demo-block>
    ...
    <demo-block title="选择时间">
      <i-datetime-picker v-model="value.time" type="time" @confirm="onConfirm" @cancel="onCancel" @change="onChange" />
    </demo-block>
