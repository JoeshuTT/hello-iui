<template>
  <view class="container">
    ...
    <demo-block title="默认选中项">
      <i-picker show-toolbar :columns="columns" :default-index="2" @change="onChange" />
    </demo-block>
    ...
    <demo-block title="多列选择">
      <i-picker ref="picker2" show-toolbar :columns="columns3" @change="onChange" />
    </demo-block>
    <demo-block title="级联选择">
      <i-picker show-toolbar title="标题" value-key="text" :columns="cascadeList" @change="onChange" />
    </demo-block>
    <demo-block title="禁用选项">
      <i-picker show-toolbar title="标题" value-key="text" :columns="columns4" @change="onChange" />
    </demo-block>
    <demo-block title="动态设置选项">
      <i-picker show-toolbar title="标题" value-key="text" :columns="columns2" @change="onChange2" />
    </demo-block>
    <demo-block title="加载状态">
      <i-picker loading show-toolbar title="标题" value-key="text" :columns="columns" @change="onChange">
