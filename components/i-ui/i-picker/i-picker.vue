    ...
    <view class="i-picker" :class="[customClass]">
        ...
        <slot>
            <view v-if="showToolbar" class="i-picker__toolbar i-hairline--bottom" :class="[toolbarClass]">
                <text class="i-picker__cancel" hover-class="i-picker__cancel--hover" hover-stay-time="70" @click="emit('cancel')"> {{ cancelButtonText }} </text>
                <text v-if="title" class="i-picker__title i-ellipsis">{{ title }}</text>
                <text class="i-picker__confirm" hover-class="i-picker__confirm--hover" hover-stay-time="70" @click="emit('confirm')"> {{ confirmButtonText }} </text>
            </view>
        </slot>
        ...
        >
            ...
            />
            <view class="i-picker__mask" :style="{backgroundSize: `100% ${(itemPxHeight * visibleItemCount - itemPxHeight) / 2 }px`}" />
