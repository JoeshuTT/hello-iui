...
<i-button type="primary" text="主要按钮" />
<i-button type="info" text="信息按钮" />
<i-button type="warning" text="警告按钮" />
...
```html
<i-button plain type="info" text="朴素按钮" />
```
...
```html
<i-button disabled type="default" text="禁用状态" />
<i-button disabled type="primary" text="禁用状态" />
```
...
```html
<i-button square type="primary" text="方形按钮" />
<i-button round type="info" text="圆形按钮" />
```
...
```html
<i-button icon="smile-o" />
<i-button icon="smile-o" type="primary" text="按钮" />
<i-button icon="/static/logo.png" plain type="info" />
```
...
```html
<i-button color="#7232dd" text="单色按钮" />
<i-button color="#7232dd" plain text="单色按钮" />
<i-button color="linear-gradient(to right, #4bb0ff, #6149f6)" text="渐变色按钮" />
```
...
```html
<i-button :custom-style="{ width: '200px', height: '100px' }" text="使用 custom-style" />
```
...
```html
<i-button type="primary" open-type="getUserInfo" @getuserinfo="getUserInfo" text="获取用户信息" />
```
...
| custom-style | 自定义根节点内联样式 | _object_ | - | - |
